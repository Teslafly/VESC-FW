...
#ifndef HW_hv_ext_adc_CORE_H_
#define HW_hv_ext_adc_CORE_H_
...
// Input voltage
#define INPUT_VOLTAGE_RAW_ADC() 	(float)ADC_Value[ADC_IND_VIN_SENS]
#define GET_INPUT_VOLTAGE()		((V_REG / 4095.0) * INPUT_VOLTAGE_ADC_VALUE() * ((VIN_R1 + VIN_R2) / VIN_R2))
...
#define NTC_TEMP(adc_ind)		hw_hvext_get_temp()
...
#define MCCONF_FOC_F_ZV					10000.0
#endif
...
float hw_hvext_get_temp(void);


#endif /* HW_hv_ext_adc_CORE_H_ */
