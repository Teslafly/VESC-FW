...
#ifndef HW_FSESC_75_3500_ALU_H_
#define HW_FSESC_75_350_ALU_H_

#define HW_NAME					"FSESC_75_350_ALU"
...
// present? but notoworking . need fto force pin off.
...
#define MCCONF_L_MIN_VOLTAGE			14.0	// from flipsky site
#endif
#ifndef MCCONF_L_MAX_VOLTAGE
#define MCCONF_L_MAX_VOLTAGE			86.0	// 20s 4.2v@84v + overhead
#endif
...
#define MCCONF_L_MAX_ABS_CURRENT		400.0	// (jaykup) (flipsky firmware) The maximum absolute current above which a fault is generated
#endif
...
#define MCCONF_L_IN_CURRENT_MAX			2000.0	// (jaykup) (flipsky firmware) Input current limit in Amperes (Upper)
#endif
#ifndef MCCONF_L_IN_CURRENT_MIN
#define MCCONF_L_IN_CURRENT_MIN			-200.0	// (jaykup) (flipsky firmware) Input current limit in Amperes (Lower)
#endif
...
// Setting limits
// 495A saturates adc pin
#define HW_LIM_CURRENT			-400.0, 400.0 // (jaykup) phase amps based on Flipsky website
#define HW_LIM_CURRENT_IN		-300.0, 300.0 // (jaykup) battery amps based on Flipsky website
#define HW_LIM_CURRENT_ABS		0.0, 450 // (jaykup) abs phase amps 1.5x burst
#define HW_LIM_VIN				6.0, 90.0 // 100v components hw max.
#define HW_LIM_ERPM				-200e3, 200e3 // (jaykup)
#define HW_LIM_DUTY_MIN			0.0, 0.1
#define HW_LIM_DUTY_MAX			0.0, 0.99
#define HW_LIM_TEMP_FET			-40.0, 110.0

#endif /* HW_FSESC_75_350_ALU_H_ */